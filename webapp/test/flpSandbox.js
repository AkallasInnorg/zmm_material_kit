		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Create kit from materia",
									"targetURL": "#zmmmaterialkit-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zmmmaterialkit-display": {
								"semanticObject": "zmmmaterialkit",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zmmmaterialkit",
									"url": sap.ui.require.toUrl("zmmmaterialkit")
								}
							}
						}
					}
